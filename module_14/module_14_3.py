...
# БД Продукты
products = [
    {"name": "Продукт 1", "description": "Описание 1", "price": 100},
    {"name": "Продукт 2", "description": "Описание 2", "price": 200},
    {"name": "Продукт 3", "description": "Описание 3", "price": 300},
    {"name": "Продукт 4", "description": "Описание 4", "price": 400},
]
...
async def get_buying_list(message: types.Message):
    for product in products:
        with open('5.jpg', 'rb') as photo:
            await message.answer_photo(photo) # Отправляем фото пользователю
